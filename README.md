...
A full-stack AI-powered trip planning application built as a university project. Users fill a multi-step form with their travel preferences and receive a complete, personalized trip itinerary generated by GPT-4.1-mini — enriched with **real-time Google Maps route data**, **live OpenWeatherMap forecasts**, and **ML-powered cost & hotel predictions** from a Python microservice.
...
| Layer | Technology |
|---|---|
| Frontend | React 19, Vite, Tailwind CSS, Redux Toolkit, React Query, React Hook Form + Yup |
